...
let countdown = new Date('2022-10-01 00:00:00').getTime();
...
function playAnimation(){
    ...
    tl.to('.time-counter', {duration: 0.3, opacity: 0})
      .to('canvas',  {css: { display:"block" }})
      .to('#new-year-text text', { duration: 3, css: { display:"block" }, ease: 'power4.outs', delay: '-5' })
      .to('#new-year-text text', { duration: 2, css: { fill: 'rgba(255,255,255,1)' }, ease: 'power4.outs', delay: '-2' })
}
